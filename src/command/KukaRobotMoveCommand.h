#ifndef KUKAROBOTMOVECOMMAND_H
#define KUKAROBOTMOVECOMMAND_H

#include <QDebug>
#include "CommandBase.h"
#include "KukaRobot.h"

class KukaRobotMoveCommand final : public CommandBase {
    Q_OBJECT

public:
    explicit KukaRobotMoveCommand(DeviceBase* device = nullptr, QObject* parent = nullptr)
    ...
    Q_INVOKABLE bool execute() override {
        ...
        if (!robot) {
            qWarning() << "KukaRobotMoveCommand: device null or wrong type";
            return false;
        }
